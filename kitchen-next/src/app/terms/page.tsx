        ...
        >
          ...
          <div className="space-y-10 text-[var(--sky-muted)]">
            ...
            <Section title="3. Оплата">
              ...
              <p className="mt-4">
                У разі відображення вартості товарів в іноземній валюті, остаточна сума до сплати 
                визначається у гривні за офіційним курсом Національного банку України, що діє на 
                дату оформлення замовлення.
              </p>
              <p className="mt-4">
                У разі використання сервісу «Покупка частинами», подальші списання коштів 
                здійснюються банком відповідно до умов такого сервісу. Компанія не впливає 
                на графік та умови списань.
              </p>
            </Section>
