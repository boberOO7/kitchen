...
export const metadata = {
  title: "Каталог",
  description: "Повний каталог кухонь SKY — від мінімалістичних до преміум.",
};
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {SKY_PRODUCTS.map((p) => (
              <Link
                key={p.slug}
                href="/configurator"
                className="group block overflow-hidden border border-[var(--sky-card-border)] bg-[var(--sky-card-bg)] shadow-[var(--sky-shadow)] transition hover:shadow-lg"
