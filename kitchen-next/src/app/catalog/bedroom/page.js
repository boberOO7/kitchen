...
export const metadata = {
  title: "Спальні",
  description: "Колекція меблів для спальні SKYY — скоро у продажу.",
};

export default function BedroomCatalogPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
          ...
          <AnimateOnScroll variant="fadeUp" delay={0.1}>
            <h1 className="mt-4 text-3xl font-light tracking-[-0.02em] text-[var(--sky-hero-fg)] sm:text-4xl">
              Спальні <span className="font-normal">SKYY</span>
            </h1>
          </AnimateOnScroll>
          
          <AnimateOnScroll variant="fadeUp" delay={0.2}>
            <p className="mt-3 max-w-[48ch] text-sm leading-relaxed text-[var(--sky-hero-muted)]">
              Меблі для спальні в стилі мінімалізму — скоро у нашому каталозі.
            </p>
          </AnimateOnScroll>
        </div>
      </section>
          ...
          <AnimateOnScroll variant="fadeUp">
            <div className="mx-auto max-w-[600px] text-center">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[var(--sky-muted)]">
                Ми працюємо над колекцією меблів для спальні. Залиште свій контакт, 
